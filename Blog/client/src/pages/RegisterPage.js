...
export default function RegisterPage() {
  ...
  return (
    ...
    <h1>Register</h1>
    <input type='text' placeholder='Username' name="username" value={registerUser.username} onChange={handleChange}/>
    {/* <input type='text' placeholder='Email' name="email" value={registerUser.email}  onChange={handleChange}/> */}
    <input type='text' placeholder='Password' name="password" value={registerUser.password}  onChange={handleChange}/>
